...
export default function TesChart() {
  ...
  const fetchData = async (start, end) => {
    ...
    setError('');
    try {
      const response = await fetch(`/api/unschedulePortableData?startDate=${start}&endDate=${end}`);
  ...
  const fetchMTDData = async () => {
    try {
      const response = await fetch('/api/mtdUnschedulePortableData');
  ...
  return (
    <Layout>
      <div className="container mx-auto p-4">
        <h1 className="text-2xl font-bold mb-4">Unschedule Network</h1>
          ...
          <div className="flex flex-wrap -mx-2">
            <div className="w-full lg:w-2/3 px-2">
              <div className="mb-4 bg-white p-4 rounded-lg shadow" style={{ height: '500px' }}>
                <h2 className="text-xl font-semibold mb-2">Pekerjaan Unschedule</h2>
            ...
            <div className="w-full lg:w-1/3 px-2">
              <div className="mb-4 bg-white p-4 rounded-lg shadow">
                <h2 className="text-lg font-semibold mb-2">Top Pekerjaan Unschedule - {getCurrentMonth()}</h2>
